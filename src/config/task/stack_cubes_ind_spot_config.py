...
_initial_objects = {
    "Cube R": {"pose": [0.615, -0.2, 0.02, 0, 1, 0, 0]},  # Red
    "Cube G": {"pose": [0.615, 0.0, 0.02, 0, 1, 0, 0], "color": [0, 1, 0, 1]},  # Green
    "Cube B": {"pose": [0.615, 0.2, 0.02, 0, 1, 0, 0], "color": [0, 0, 1, 1]},  # Blue
}
...
_target_objects_pose = {
    "Cube R": [0.615, float("nan"), 0.02, 0, 1, 0, 0],
    "Cube G": [0.615, float("nan"), 0.1, 0, 1, 0, 0],
    "Cube B": [0.615, float("nan"), 0.06, 0, 1, 0, 0],
}
